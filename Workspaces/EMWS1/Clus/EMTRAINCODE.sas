...
*------------------------------------------------------------* ;
%macro DMDBClass;
    IMP_node_caps(ASC) irradiat(ASC)
%mend DMDBClass;
*------------------------------------------------------------* ;
* Clus: DMDBVar Macro ;
*------------------------------------------------------------* ;
%macro DMDBVar;
    AvgTumorSize Avginv_node_group deg_malig
%mend DMDBVar;
*------------------------------------------------------------*;
* Clus: Create DMDB;
*------------------------------------------------------------*;
...
code file="D:\\127097210_Pahuja\Workspaces\EMWS1\Clus\DMVQSCORECODE.sas"
group=Clus
;
run;
quit;
...
*------------------------------------------------------------* ;
%macro dmvqvars;
    AvgTumorSize Avginv_node_group deg_malig IMP_node_capsno IMP_node_capsyes
   irradiatno irradiatyes
%mend ;
*------------------------------------------------------------*;
